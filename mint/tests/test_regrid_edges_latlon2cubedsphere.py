...
def test_1b():
    ...
    # cubed-sphere
    dgrid.setFlags(1, 1)
    dgrid.loadFromUgrid2DFile(f'{DATA_DIR}/lfric_diag_ori.nc$Mesh2d')
    ...
    # save the grids and fields to VTK files
    sgrid.dump('sgrid.vtk')
    dgrid.dump('dgrid_ori.vtk')

    mint.printLogMessages()
    mint.writeLogMessages('test_regrid_edges_latlon2cubedsphere_ori.log')
