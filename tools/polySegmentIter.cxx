...
int main(int argc, char** argv) {
    ...
    args.set("-P", 0., "Periodicity length (leave 0 if non-periodic)");
    ...
    ier = mnt_grid_loadFromUgrid2DFile(&grd, srcFileMesh.c_str());
    if (ier != 0) {
    ...
    loc->BuildLocator();
    loc->setPeriodicityLengthX(args.get<double>("-P"));
