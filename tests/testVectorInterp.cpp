...
void testSlanted() {
    ...
    */
    ...
    std::cout << "W1: edge " << ie << ": u,v = " << uEdgesW1[ie]*deg2rad << ',' << vEdgesW1[ie]*deg2rad << " exact: " << uExact << ',' << vExact << '\n';
    ...
    std::cout << "W2: edge " << ie << ": u,v = " << uEdgesW2[ie]*deg2rad << ',' << vEdgesW2[ie]*deg2rad << " exact: " << uExact << ',' << vExact << '\n';
