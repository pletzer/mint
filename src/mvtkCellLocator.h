/*=========================================================================
  ...
  Module:    mmvtkCellLocator.h (modified by Alex Pletzer)
...
=========================================================================*/
/**
 * @class   mvtkCellLocator
 * @brief   octree-based spatial search object to quickly locate cells
 *
 * mvtkCellLocator is a spatial search object to quickly locate cells in 3D.
 * mvtkCellLocator uses a uniform-level octree subdivision, where each octant
 ...
 * candidate cells, or intersection with another mvtkCellLocator to return
 * candidate cells.
 *
 * @warning
 * Many other types of spatial locators have been developed, such as
 * variable depth octrees and kd-trees. These are often more efficient
 * for the operations described here. mvtkCellLocator has been designed
...
#ifndef mvtkCellLocator_h
#define mvtkCellLocator_h
...
class VTKCOMMONDATAMODEL_EXPORT mvtkCellLocator : public vtkAbstractCellLocator
{
public:
  vtkTypeMacro(mvtkCellLocator,vtkAbstractCellLocator);
...
private:
  mvtkCellLocator(const mvtkCellLocator&) = delete;
  void operator=(const mvtkCellLocator&) = delete;
};
